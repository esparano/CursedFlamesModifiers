package cursedflames.modifiers;//package cursedflames.modifiers;
//
...
//    if (cursedflames.modifiers.Modifiers.curio_pool.isApplicable.test(stack)) {
//      return cursedflames.modifiers.Modifiers.curio_pool.roll(random);
//    }
//    if (cursedflames.modifiers.Modifiers.tool_pool.isApplicable.test(stack)) {
//      return cursedflames.modifiers.Modifiers.tool_pool.roll(random);
//    }
//    return null;
//  }
//
...
//    return cursedflames.modifiers.Modifiers.modifiers.get(new ResourceLocation(tag.getString(tagName)));
//  }
//
