...
public class Modifiers {
  ...
  public static cursedflames.modifiers.ModifierPool curio_pool = new cursedflames.modifiers.ModifierPool(stack -> {
  ...
  public static cursedflames.modifiers.ModifierPool tool_pool = new cursedflames.modifiers.ModifierPool(stack -> {
